...
def main():
    ...
    dx_def_filename = '/home/chuck/projects/Vision/examples/c3d_ucf101/TEMP_c3d_ucf101_deploy_8conv_model_v2.prototxt'
    converted_dx_wgt_filename = '/home/chuck/projects/Vision/examples/c3d_ucf101/c3d_ucf101_finetune_iter_20000_v2.caffemodel'

    #################################################
    # load FB model
    if not os.path.isfile(fb_all_pkl):
        sys.path.insert(0, "/home/chuck/projects/facebook-C3D/python")
        print "[Debug] sys.path={}".format(sys.path)
    ...
    if not os.path.isfile(dx_all_pkl):
        sys.path.insert(0, "/home/chuck/projects/Vision/python")
        print "[Debug] sys.path={}".format(sys.path)
        import caffe as dx_caffe
        print "[Debug] dx_caffe.__file__={}".format(dx_caffe.__file__)
        print "[Debug] dx_caffe.__path__={}".format(dx_caffe.__path__)
        print "[Debug] dx_caffe.__version__={}".format(dx_caffe.__version__)
